...
var Patriots1 = $.ajax({
  ...
  series.columns.template.adapter.add("fill", function(fill, target) {
    if (target.dataItem && (target.dataItem.valueY > 95)) {
      return am4core.color("#1e3188");
    }
    if (target.dataItem && (target.dataItem.valueY > 90)) {
      return am4core.color("#1d5aa5");
    }
    if (target.dataItem && (target.dataItem.valueY > 88)) {
      return am4core.color("#1d5aa5");
    }
    if (target.dataItem && (target.dataItem.valueY > 87)) {
      return am4core.color("#1d5aa5");
    }
    if (target.dataItem && (target.dataItem.valueY > 84)) {
      return am4core.color("#3b9dc3");
    }
    if (target.dataItem && (target.dataItem.valueY > 79)) {
      return am4core.color("#6ac1cc");
    }
    if (target.dataItem && (target.dataItem.valueY > 76)) {
      return am4core.color("#82d2d0");
    }
    if (target.dataItem && (target.dataItem.valueY > 74)) {
      return am4core.color("#86d0ae");
    }
    if (target.dataItem && (target.dataItem.valueY > 68)) {
      return am4core.color("#b6e4a9");
    }
    if (target.dataItem && (target.dataItem.valueY > 66)) {
      return am4core.color("#b6e4a9");
    }
    if (target.dataItem && (target.dataItem.valueY > 59)) {
      return am4core.color("#daf0cf");
    }
    if (target.dataItem && (target.dataItem.valueY > 56)) {
      return am4core.color("#daf0cf");
    }
